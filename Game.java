...
public class Game {
	...
	public void playerSetUp() {
		...
		playerWeapon = "Knife";
        System.out.println("This is a adventure game in which there are only humans and goblins");
		System.out.println("Your task is to enter the town!!");
		System.out.println("Inorder to enter the town, You need to gain the trust of the guard");
